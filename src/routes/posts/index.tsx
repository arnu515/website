    ...
    <dl class="mt-4 ml-4">
      ...
      <>
        <dt class="text-xl pt-4">
          ...
          {post.suggested && <svg aria-label="Suggested" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-5 text-peach/70 inline-block ml-2 mb-1">
