...
export function normalizeFrontmatter(frontmatter: Record<string, unknown> | null | undefined): PostFrontmatter | null {
  ...
  return {
    ...
    summary: typeof frontmatter.summary === 'string' ? frontmatter.summary : "Unknown summary",
    tags: Array.isArray(frontmatter.tags) ? frontmatter.tags : [],
    suggested: typeof frontmatter.suggested === 'boolean' ? frontmatter.suggested : false,
...
export const getSuggestedPosts = routeLoader$(
  async () => getAllPosts().filter(i => i.suggested)
)

// eslint-disable-next-line qwik/loader-location
export const getPosts = routeLoader$(
  async () => getAllPosts()
)
